...
def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
	p = argparse.ArgumentParser(description="Convert Label Studio export JSON to annotated speaker-turn CSV")
...
def main(argv: Optional[List[str]] = None) -> int:
	...
	out_df = pd.DataFrame(rows, columns=["debate_id", "speaker", "text", "check_worthy", "spans", "error"])
